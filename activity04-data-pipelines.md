...
**Response**: The console output will be shown if message is turned on.
...
use? A: readr::read\_csv is better
...
``` r
rearrange_college <- college_recent_grads %>% arrange(unemployment_rate)
```
...
head(stem_low_salaries)
```

    ## # A tibble: 6 x 5
    ##   major                                 major_category        p25th median p75th
    ##   <chr>                                 <chr>                 <dbl>  <dbl> <dbl>
    ## 1 Zoology                               Biology & Life Scien… 20000  26000 39000
    ## 2 Ecology                               Biology & Life Scien… 23000  33000 42000
    ## 3 Biology                               Biology & Life Scien… 24000  33400 45000
    ## 4 Miscellaneous Biology                 Biology & Life Scien… 23000  33500 48000
    ## 5 Multi-Disciplinary Or General Science Physical Sciences     24000  35000 50000
    ## 6 Physiology                            Biology & Life Scien… 20000  35000 50000

``` r
median(college_recent_grads$median)
```
...
**Response**: Zoology, Ecology, and Biology.
